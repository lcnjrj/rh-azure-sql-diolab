...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        _context.SaveChanges(); // TODO resolvido: salva no banco SQL

        var tableClient = GetTableClient();
        var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao, funcionario.Departamento, Guid.NewGuid().ToString());

        tableClient.UpsertEntity(funcionarioLog); // TODO resolvido: salva log no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // TODO resolvido: todas as propriedades atualizadas
        ...
        _context.Funcionarios.Update(funcionarioBanco); // TODO resolvido: marca como modificado
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.Funcionarios.Remove(funcionarioBanco); // TODO resolvido: remove do banco SQL
        _context.SaveChanges();
